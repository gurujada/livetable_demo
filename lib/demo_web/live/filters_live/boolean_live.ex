defmodule DemoWeb.Filters.BooleanLive do
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "Boolean Filters")}
  end
      ...
      <div class="bg-base-100 border-b border-base-200">
        <div class="container mx-auto px-6 py-8">
          <div class="flex items-center gap-4">
            ...
            <div>
              <h1 class="text-3xl font-bold">Boolean Filters</h1>
              <p class="opacity-70">Simple toggle-based filtering for status and flags</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-base-200/50 py-4">
        <div class="container mx-auto px-6">
          <div class="bg-info/10 border border-info/20 rounded-lg p-4 flex items-start gap-3">
            ...
            <div>
              <h3 class="font-bold">Try the toggle filters:</h3>
              <div class="text-sm">
                Use Active Products, Featured Products, and In Stock toggles to filter results instantly
              </div>
            </div>
          </div>
        </div>
